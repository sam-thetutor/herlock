...
module {
  ...
  // The fee for the `sign_with_ecdsa` endpoint.
  // Note: The actual cost can vary. Error message indicated ~26 billion cycles required.
  // Using 30 billion to provide a safety buffer.
  let SIGN_WITH_ECDSA_COST_CYCLES : Cycles = 30_000_000_000;
